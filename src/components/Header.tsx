        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            ...
            {user && !subscriptionStatus.isPremium && (
              <Link
                href="/pricing"
                className="hidden sm:flex items-center gap-2 px-4 py-2 bg-white/10 hover:bg-white/20 backdrop-blur-xl border border-white/30 hover:border-white/50 transition-all duration-200 rounded-full text-sm font-semibold"
              >
            ...
            {/* Log In link — only shown to unauthenticated users, subtle so it doesn't compete with the trial CTA */}
            {!user && (
              <button
            ...
            <div className="relative">
              ...
              >
                <div className="w-6 h-6 bg-white/20 backdrop-blur-xl border border-white/40 rounded-full flex items-center justify-center text-xs font-bold">
                  {user.email?.[0]?.toUpperCase() || 'U'}
                </div>
                <span className="text-sm">
                  {subscriptionStatus.isPremium ? 'Pro' : subscriptionStatus.isTrialing ? 'Trial' : 'Free'}
                </span>
              </button>
